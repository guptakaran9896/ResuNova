      ...
      >
        <div ref={printElem}>
          <HStack>
            ...
            <VStack m={4} alignItems={"flex-start"} spacing={0.5}>
              <Heading as="h4" size="md">
                {about.name ? about.name : "Karan Gupta"}
              </Heading>
              <Text color={"gray.500"}>
                {about.role ? about.role : "Software Developer"}
              </Text>
            </VStack>
          </HStack>
          ...
          >
            <HStack spacing={1}>
              <MdMail />{" "}
              <Text>{about.email ? about.email : "karan999867@gmail.com"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocalPhone />{" "}
              <Text>{about.phone ? about.phone : "+9112345678"}</Text>
            </HStack>
            <HStack spacing={1}>
              <MdLocationPin />{" "}
              <Text>{about.address ? about.address : "Kurukshetra, Haryana"}</Text>
            </HStack>
            <HStack spacing={1}>
              <RiLinkedinBoxFill />{" "}
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {degree ? degree : "B.Tech Electronics and Communication"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {school ? school : "NIT Kurukshetra"}
                      </Text>
                      <HStack
                        fontSize={"xs"}
                        fontStyle={"italic"}
              ...
              <VStack alignItems={"flex-start"}>
                ...
                {workList.map((work) => {
                  ...
                  return (
                    ...
                    >
                      <Text fontWeight={"medium"}>
                        {position ? position : "Sotware Developer"}
                      </Text>
                      <Text fontSize={"sm"}>
                        {company ? company : "XYZ "} -{" "}
                        {type ? type : "Full-time"}
                      ...
                      <Text fontSize={"xs"} fontStyle={"italic"}>
                        ...
                        {endDate ? endDate : "2023-06"}
                      </Text>
                      <Text fontSize={"sm"} as="p">
                        {desc
                          ? desc
                          : "Developed a Dahboard for Client-vendor"}
                      </Text>
                    </VStack>
                  );
                })}
